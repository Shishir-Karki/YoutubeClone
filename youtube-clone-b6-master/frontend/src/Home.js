...
import joji from './images/joji.jpeg'
import radiohead from './images/images.png'
import blonded from './images/blonded.jpeg'
        ...
        <div>
            ...
            <div class="main-section">
                <div class="main-left">
                    ...
                    <button class="yt-side-button">
                        <img src={radiohead} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">Radiohead</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={joji} height={'30px'} width={'30px'}></img>

                        <span class="side-channel-label">Joji</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={blonded} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">blonded</span>
                    </button>
                </div>
